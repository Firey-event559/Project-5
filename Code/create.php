...
?>
    ...
    <form class="create_book" method="post" action="books_create.php">
        <h1 class="account">Nieuw boek toevoegen</h1>
        <input class="create_account_input" type="text" placeholder="titel" required name="title" id="title">
        <div name=""></div>
        ...
        <input class="create_book_input" type="text" placeholder="samenvatting" required name="book_information">
